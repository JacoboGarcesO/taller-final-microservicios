...
class UserServiceTest {
    ...
    void register_ShouldSaveUser_WhenUsernameDoesNotExist() {
        RegisterRequest request = new RegisterRequest("bladimir", "123", null);
    ...
    void register_ShouldReturnError_WhenUserAlreadyExists() {
        RegisterRequest request = new RegisterRequest("bladimir", "1234", null);
        User existingUser = new User("1", "bladimir", null, null);
